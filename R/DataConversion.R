...
createSccsEraData <- function(sccsData,
  ...
  data <- convertToSccs.ffdf(sccsData$cases,
                             erasSubset,
                             covariateStart,
...
#' @export
convertToSccs.data.frame <- function(cases,
                                     eras,
                                     covariateStart = 0,
                                     covariatePersistencePeriod = 0,
                                     naivePeriod = 0,
...
convertToSccs.fakeDf <- function(cases,
                                 ...
                                 naivePeriod = 0,
                                 firstOutcomeOnly = FALSE) {
  return(.Call("SelfControlledCaseSeries_convertToSccs",
               PACKAGE = "SelfControlledCaseSeries",
               cases,
               eras,
               covariateStart,
