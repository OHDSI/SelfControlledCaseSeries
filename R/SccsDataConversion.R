...
createSccsIntervalData <- function(studyPopulation,
  ...
  convertToSccs(
    ...
    outcomes = outcomes,
    eras = sccsData$eras,
    includeAge = !all.equal(settings$ageDesignMatrix, matrix()),
    ageOffset = settings$ageOffset,
    ageDesignMatrix = settings$ageDesignMatrix,
    includeSeason = !all.equal(settings$seasonDesignMatrix, matrix()),
    seasonDesignMatrix = settings$seasonDesignMatrix,
    includeCalendarTime = !all.equal(settings$seasonDesignMatrix, matrix()),
