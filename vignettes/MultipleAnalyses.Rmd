...
createEraDataArgs2 <- createCreateSccsEraDataArgs(naivePeriod = 180,
                                                  firstOutcomeOnly = FALSE,
...
sccsAnalysis2 <- createSccsAnalysis(analysisId = 2,
                                    ...
                                    getDbSccsDataArgs = getDbSccsDataArgs1,
                                    createSccsEraDataArgs = createEraDataArgs2,
                                    fitSccsModelArgs = fitSccsModelArgs)
...
createEraDataArgs3 <- createCreateSccsEraDataArgs(naivePeriod = 180,
                                                  firstOutcomeOnly = FALSE,
                                                  covariateSettings = list(covarExposureOfInt, 
                                                                           covarProphylactics),
...
sccsAnalysis3 <- createSccsAnalysis(analysisId = 3,
                                    ...
                                    getDbSccsDataArgs = getDbSccsDataArgs1,
                                    createSccsEraDataArgs = createEraDataArgs3,
                                    fitSccsModelArgs = fitSccsModelArgs)
...
createEraDataArgs4 <- createCreateSccsEraDataArgs(naivePeriod = 180,
                                                  firstOutcomeOnly = FALSE,
                                                  covariateSettings = list(covarExposureOfInt, 
                                                                           covarAllDrugs))
...
sccsAnalysis4 <- createSccsAnalysis(analysisId = 4,
                                    ...
                                    getDbSccsDataArgs = getDbSccsDataArgs1,
                                    createSccsEraDataArgs = createEraDataArgs4,
                                    fitSccsModelArgs = fitSccsModelArgs)
```
...
sccsAnalysisA <- createSccsAnalysis(analysisId = 1,
                                    description = "Simplest model, using narrow definition",
...
sccsAnalysisB <- createSccsAnalysis(analysisId = 2,
                                    description = "Simplest model, using broad definition",
...
sccsModelFile <- result$sccsModelFile[result$exposureId == 1124300 & 
                                      result$outcomeId == 1 &
                                      result$analysisId == 1]
sccsModel <- readRDS(sccsModelFile)
summary(sccsModel)
```
```{r echo=FALSE,message=FALSE}
if (file.exists("s:/temp/sccsVignette2/outcomeModelReference.rds")){
...
```
```{r echo=FALSE,message=FALSE}
if (file.exists("s:/temp/sccsVignette2/analysisSummary.rds")){
  analysisSum <- readRDS("s:/temp/sccsVignette2/analysisSummary.rds")
  head(analysisSum)
}
```
...
```{r tidy=FALSE,eval=FALSE}
# Analysis 3: Including prophylactics, age, season, and censoring
