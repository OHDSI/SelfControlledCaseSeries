...
3. Arguments that are the output of a previous function in the `SelfControlledCaseSeries` package, such as the `sccsData` argument of the `createSccsIntervalData` function. These cannot be specified by the user.
...
createEraDataArgs1 <- createCreateSccsIntervalDataArgs(naivePeriod = 180,
...
sccsAnalysis1 <- createSccsAnalysis(analysisId = 1,
                                    ...
                                    createSccsIntervalDataArgs = createEraDataArgs1,
...
result <- runSccsAnalyses(connectionDetails = connectionDetails,
                          ...
                          createSccsIntervalDataThreads = 5,
